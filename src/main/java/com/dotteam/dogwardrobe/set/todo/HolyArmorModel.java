package com.dotteam.dogwardrobe.set.todo;/*
package com.dotteam.dogwardrobe.model.todo;
	...
	public HolyArmorModel(EquipmentSlotType slot, boolean isSteve, float scale) {
		...
		switch (slot) {
			case HEAD:
				...
				setRotationAngle(headWingRight, 0.3491F, -0.4363F, 0.0F);
			...
			case CHEST:
				...
				if(isSteve){
					...
					setRotationAngle(armLeftEffect, 0.0F, 0.0F, 1.0F);
